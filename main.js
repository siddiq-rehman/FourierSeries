...
function SAFE_HEAP_STORE(dest, value, bytes, isFloat) {
 ...
 if (dest + bytes > GROWABLE_HEAP_U32()[DYNAMICTOP_PTR >> 2]) abort("segmentation fault, exceeded the top of the available dynamic heap when storing " + bytes + " bytes to address " + dest + ". DYNAMICTOP=" + GROWABLE_HEAP_I32()[DYNAMICTOP_PTR >> 2]);
 assert(DYNAMICTOP_PTR);
 assert(GROWABLE_HEAP_I32()[DYNAMICTOP_PTR >> 2] <= GROWABLE_HEAP_I8().length);
...
function SAFE_HEAP_LOAD(dest, bytes, unsigned, isFloat) {
 ...
 if (dest + bytes > GROWABLE_HEAP_U32()[DYNAMICTOP_PTR >> 2]) abort("segmentation fault, exceeded the top of the available dynamic heap when loading " + bytes + " bytes from address " + dest + ". DYNAMICTOP=" + GROWABLE_HEAP_I32()[DYNAMICTOP_PTR >> 2]);
 assert(DYNAMICTOP_PTR);
 assert(GROWABLE_HEAP_I32()[DYNAMICTOP_PTR >> 2] <= GROWABLE_HEAP_I8().length);
 ...
 stream_ops: {
  ...
  mmap: function(stream, buffer, offset, length, position, prot, flags) {
   ...
   if (!(flags & 2) && contents.buffer === buffer.buffer) {
    ...
    allocated = true;
    var fromHeap = buffer.buffer == GROWABLE_HEAP_I8().buffer;
    ptr = _malloc(length);
    if (!ptr) {
     throw new FS.ErrnoError(48);
    }
    (fromHeap ? GROWABLE_HEAP_I8() : buffer).set(contents, ptr);
   }
   return {
    ptr: ptr,
    allocated: allocated
...
function __emscripten_do_pthread_join(thread, status, block) {
 ...
 for (;;) {
  ...
  if (threadStatus == 1) {
   ...
   if (status) SAFE_HEAP_STORE(status | 0, threadExitCode | 0, 4);
...
var _setFunctionData = Module["_setFunctionData"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["setFunctionData"].apply(null, arguments);
};

var _getLength = Module["_getLength"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["getLength"].apply(null, arguments);
};

var _getFourierCoefficientRealPart = Module["_getFourierCoefficientRealPart"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["getFourierCoefficientRealPart"].apply(null, arguments);
};

var _getFourierCoefficientImgPart = Module["_getFourierCoefficientImgPart"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["getFourierCoefficientImgPart"].apply(null, arguments);
};

var _doThreadingForCoeffThread = Module["_doThreadingForCoeffThread"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["doThreadingForCoeffThread"].apply(null, arguments);
};

var _doThreadingForCoeff = Module["_doThreadingForCoeff"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["doThreadingForCoeff"].apply(null, arguments);
};
...
var _do_emscripten_dispatch_to_thread = Module["_do_emscripten_dispatch_to_thread"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["do_emscripten_dispatch_to_thread"].apply(null, arguments);
};
...
var __emscripten_call_on_thread = Module["__emscripten_call_on_thread"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["_emscripten_call_on_thread"].apply(null, arguments);
};
...
var dynCall_vdiiii = Module["dynCall_vdiiii"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["dynCall_vdiiii"].apply(null, arguments);
};
